...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            print(f"\nWhich {menu_category_name} would you like to order?\n ")
            i = 1
            menu_items = {}
            ...
            menu_selection = input("\nPlease choose an item number from the menu options? ")
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    quantity = input(f"\nHow many {menu_selection_name} do you want? ")
...
print (f"\nThe total cost for your order is: ${total: ,.2f}\n")
